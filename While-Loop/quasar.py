...
def session(bet):
    ...
    if pay>=0:
        print('You won %d credits.' %pay)
    else:
        print('You lost %d credits.' %abs(pay))
...
def play(credits):
    ...
    halted=False
    print('You have %d credits.' %credits)
    ...
    while not halted:
        ...
        if credits==0:
            ...
            if response=='p':
                print('You leave with %d credits.' %credits)
                halted=True
